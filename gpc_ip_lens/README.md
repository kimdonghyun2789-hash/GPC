...
| 3. Patent DNA | 아이디어 vs 특허 구조 비교표 (대상/문제/해결수단/…) |
| 4. Tech Landscape | 연도별 추이, 출원인 TOP, IPC/상태/기술군 분포, 히트맵 |
| 5. Technology Timeline | 기술발전도 (기술군별 추이 + 흐름 문장화) |
| 6. Time Network Map | X=연도, Y=기술군 시간축 네트워크맵 (★=내 아이디어) |
| 7. Drawing Intelligence | 대표도면 중심 검토 (정렬/캡션 자동 생성) |
| 8. AI Patent Review | Gemini 기반 1차 검토 (공통/차이/회피설계 포인트) |
| 9. Strategy Board | 공백 분석, 성장성, 출원인 전략, 생존성 분석 |
| 10. Export Center | Excel / PDF 리포트 / 그래프·네트워크맵 이미지 |
| 11. Settings | API Key 입력·저장, mock 전환, DB 초기화, 캐시 삭제 |
...
| 항목 | 가중치 | 방법 |
|---|---|---|
| 벡터 의미 유사도 | 30 | Gemini embedding → 실패 시 TF-IDF cosine |
| 특허 DNA 유사도 | 25 | 대상20/문제15/해결수단30/구성요소15/시점10/효과10 |
| 키워드 일치도 | 20 | 제목/요약/청구항 일치 + 동시출현 |
| 대표청구항 유사도 | 15 | TF-IDF cosine |
| IPC/CPC 일치 | 5 | 기술군-IPC 매핑 |
| AI 위험도 보정 | 5 | Gemini 또는 상기 평균 |

등급: 0~39 낮음 / 40~59 관련 있음 / 60~79 유사 / **80~100 고유사·주의**
